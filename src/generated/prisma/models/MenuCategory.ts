...
export interface MenuCategoryDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `menuCategoryId`
   * const menuCategoryWithMenuCategoryIdOnly = await prisma.menuCategory.findMany({ select: { menuCategoryId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many MenuCategories and only return the `menuCategoryId`
   * const menuCategoryWithMenuCategoryIdOnly = await prisma.menuCategory.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more MenuCategories and only return the `menuCategoryId`
   * const menuCategoryWithMenuCategoryIdOnly = await prisma.menuCategory.updateManyAndReturn({
   *   select: { menuCategoryId: true },
   *   where: {
   *     // ... provide filter here
   *   },
